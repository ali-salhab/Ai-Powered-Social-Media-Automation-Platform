...
export default function Hero() {
  return (
    <section className="relative overflow-visible">
      ...
      <div className="absolute inset-0  bg-[linear-gradient(rgba(1,0,0,0.09)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.09)_1px,transparent_1px)] bg-size-[50px_50px] pointer-events-none" />
      ...
      <div className=" max-w-6xl px-5 sm:px-8 pt-20 pb-12 text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 bg-red-50 border border-red-100 text-red-500 text-sm px-3.5 py-1.5 rounded-full mb-8">
          <span className="size-2.5 bg-red-400 rounded-2xl" />
          AI-Powered SocialPosts
        </div>
